...
В рамках данного задания написана программа **Схема движения по азимутам**, в которой применен пакет [matplotlib](https://pypi.org/project/matplotlib/), позволяющий построить график схемы в декартовой системе координат.
